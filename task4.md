...
- Gia tăng tốc độ reverse proxy thông qua bộ nhớ đệm (cache), phục vụ cho các tập tin tĩnh tốt hơn apache và lập chỉ mục cho tập tin, sao lưu nhật kí truy vấn
